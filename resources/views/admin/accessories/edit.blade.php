                ...
                <div class="card-content">
                        ...
                        <div class="mdc-form-field mdc-form-field--inline">
                            ...
                            <div class="mdc-radio">
                                <input class="mdc-radio__native-control" type="radio" id="game_ets2" name="game"
                                       value="ets2" @if($accessory->game == 'ets2') checked @endif>
                            ...
                            <div class="mdc-radio">
                                <input class="mdc-radio__native-control" type="radio" id="game_ats" name="game"
                                       value="ats" @if($accessory->game == 'ats') checked @endif>
                                <div class="mdc-radio__background">
                                    <div class="mdc-radio__outer-circle"></div>
                                    <div class="mdc-radio__inner-circle"></div>
                                </div>
                    ...
                    <div class="row no-margin">
                        <div class="mdc-text-field mdc-text-field--outlined">
                            <input type="text" id="def" class="mdc-text-field__input" name="def" value="{{ $accessory->def }}" required>
                    ...
                    <div class="row no-margin">
                        <div class="mdc-text-field mdc-text-field--outlined">
                            <input type="text" id="suffixes" class="mdc-text-field__input" name="suffixes" value="{{ $accessory->suffixes }}">
                            <div class="mdc-notched-outline">
                                <div class="mdc-notched-outline__leading"></div>
                                <div class="mdc-notched-outline__notch">
                                    <label for="suffixes" class="mdc-floating-label">Перелік суфіксів (через кому, без пробілів)</label>
                                </div>
                                <div class="mdc-notched-outline__trailing"></div>
                            </div>
                        </div>
                    ...
                    <div class="row no-margin">
                        <div class="mdc-text-field mdc-text-field--outlined">
                            <input type="text" id="alias" class="mdc-text-field__input" name="alias" value="{{ $accessory->alias }}" required>
                            <div class="mdc-notched-outline">
                                <div class="mdc-notched-outline__leading"></div>
                                <div class="mdc-notched-outline__notch">
                    ...
                    <div class="row no-margin">
                        <div class="mdc-text-field mdc-text-field--outlined">
                            <input type="text" id="chassis" class="mdc-text-field__input" name="chassis" value="{{ $accessory->chassis }}" required>
                            <div class="mdc-notched-outline">
                                <div class="mdc-notched-outline__leading"></div>
                                <div class="mdc-notched-outline__notch">
                        ...
                        <div class="mdc-form-field col s12">
                            <div class="mdc-checkbox">
                                <input type="checkbox"
                                       ...
                                       id="active" name="active" {{ $accessory->active ? 'checked' : '' }}>
                            ...
                            <label for="active">Активний аксесуар</label>
                        </div>
                    </div>
                </div>
