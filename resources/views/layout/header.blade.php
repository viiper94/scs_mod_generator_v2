...
<link type="text/css" rel="stylesheet" href="{{ asset('assets/mdc/css/material-components-web.min.css') }}" media="screen,projection"/>
...
<link type="text/css" rel="stylesheet" href="{{ asset('assets/materialize/css/materialize.min.css?2805') }}" media="screen,projection"/>
